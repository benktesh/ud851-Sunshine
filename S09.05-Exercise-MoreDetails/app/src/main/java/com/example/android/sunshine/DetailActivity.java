...
//  DONE (20) Create a constant int to identify our loader used in DetailActivity
    ...
    public final static int INDEX_WEATHER_HUMIDITY = 3;
    public final static int INDEX_WEATHER_PRESSURE = 4;
    public final static int INDEX_WEATHER_WIND = 5;
    public final static int INDEX_WEATHER_DEGREES = 6;
    public final static int INDEX_WEATHER_ID = 7;

    final static int ID_DETAILED_LOADER = 109;
...
//      DONE (13) Find each of the TextViews by ID
        ...
        mHighView = (TextView) findViewById(R.id.tv_display_high_temperature);
        mLowView = (TextView) findViewById(R.id.tv_display_low_temperature);
        mHumidityVew = (TextView) findViewById(R.id.tv_display_humidity);
        ...
        switch (id){
            case ID_DETAILED_LOADER:
                ...
                return new CursorLoader(this,
                        ...
                        null);
            default:
                throw new RuntimeException("Dont know this loader: " + id);
        }
    }
...
//      DONE (33) Store a forecast summary in mForecastSummary
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        String high = SunshineWeatherUtils.formatTemperature(this, data.getDouble(INDEX_WEATHER_MAX_TEMP));
        mHighView.setText(high);

        String low = SunshineWeatherUtils.formatTemperature(this, data.getDouble(INDEX_WEATHER_MIN_TEMP));
        mLowView.setText(low);

        String humidity = getString(R.string.format_humidity,data.getFloat(INDEX_WEATHER_HUMIDITY));
        mHumidityVew.setText(humidity);

        String windString = SunshineWeatherUtils.getFormattedWind(this, data.getFloat(INDEX_WEATHER_WIND), data.getFloat(INDEX_WEATHER_DEGREES));
