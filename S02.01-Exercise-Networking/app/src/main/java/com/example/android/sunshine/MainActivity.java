...
public class MainActivity extends AppCompatActivity {
    ...
    // COMPLETE (8) Create a method that will get the user's preferred location and
    ...
    private void loadWeatherData(){
        ...
        Log.d(this.toString(), "loadWeatherData: preffered  " + preferredLocation);
        URL preferredSearchUrl = NetworkUtils.buildUrl(preferredLocation);
        new FetchWeatherTask().execute(preferredSearchUrl);
    }
    ...
    private class FetchWeatherTask extends AsyncTask<URL, Void, String> {
        ...
        protected String doInBackground(URL... urls) {
            ...
            Log.d("doInBackground: ", searchResult);
            return searchResult;
        }
